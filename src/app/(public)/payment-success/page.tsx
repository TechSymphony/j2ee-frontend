                    ...
                    <div className="space-y-4">
                        {missingData ? (
                            <p className="text-red-600">
                                Một số thông tin thanh toán bị thiếu. Vui lòng
                                kiểm tra lại liên kết hoặc liên hệ hỗ trợ.
                            </p>
                        ) : (
                            <>
                                <p>
                                    Cảm ơn bạn đã thanh toán! Giao dịch của bạn
                                    đã thành công.
                                </p>
                                <div className="space-y-2">
                                    ...
                                    <p className="text-gray-600 mt-4">
                                        Kết quả sẽ được cập nhật trong khoảng
                                        vài phút đến tối đa 30 phút. Chúng tôi
                                        trân trọng sự thông cảm và kiên nhẫn của
                                        quý khách.
                                    </p>
                                </div>
                            </>
