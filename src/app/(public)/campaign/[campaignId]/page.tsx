                        ...
                        <div className="md:col-span-2 space-y-6">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow">
                                ...
                                <p className="text-gray-600 text-sm italic">
                                    Sau những nụ cười hạnh phúc là hoàn cảnh gia đình khó khăn khiến các em có nguy cơ không được đến trường
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow">
                                <h2 className="text-xl font-semibold mb-4">Nhà hảo tâm hàng đầu</h2>
                                <ul className="space-y-2">
                                    {[
                                        { name: "Tạ Quý Đạt", amount: "1.000.000đ" },
                                        { name: "Nhà hảo tâm", amount: "220.000đ" },
                                        { name: "Đoàn Thị Thu Huyền", amount: "120.000đ" },
                                        { name: "Trương Quang Vũ", amount: "100.000đ" },
                                        { name: "Nguyễn Văn Trường", amount: "100.000đ" },
                                        { name: "Phạm Vũ Thảo Ly", amount: "100.000đ" },
                                        { name: "Nguyễn Trương Ngọc Thy", amount: "100.000đ" },
                                        { name: "Nguyễn Khôi", amount: "100.000đ" },
                                        { name: "Võ Văn Trà Win", amount: "100.000đ" },
                                        { name: "Đào Đức Vinh", amount: "100.000đ" },
                                    ].map((donor, index) => (
                            ...
                            <div className="bg-white p-6 rounded-lg shadow">
                                <h2 className="text-xl font-semibold mb-4">Nhà hảo tâm mới nhất</h2>
                                <ul className="space-y-2">
                                    {[
                                        { initials: "NL", name: "Trần Thị Ngọc Lan", amount: "1.311đ" },
                                        { initials: "VD", name: "Trần Việt Dũng", amount: "1.000đ" },
                                        { initials: "VK", name: "Bùi Văn Kiên", amount: "1.000đ" },
                                        { initials: "TV", name: "Trần Lê Trường Vĩ", amount: "2.000đ" },
                                        { initials: "NN", name: "Nguyễn Hữu Nghĩa", amount: "1.000đ" },
                                        { initials: "NT", name: "Nhà hảo tâm", amount: "10.000đ" },
                                        { initials: "LN", name: "Lê Ái Nhân", amount: "10.000đ" },
                                        { initials: "NL", name: "Nguyễn Thị Thu Lê", amount: "1.000đ" },
                                        { initials: "QV", name: "Liên Quang Vinh", amount: "1.000đ" },
                                        { initials: "DP", name: "Thái Duy Phong", amount: "1.000đ" },
                                    ].map((donor, index) => (
                            ...
                            <div className="w-full max-w-sm border border-gray-200 bg-white rounded-xl shadow-sm hover:shadow-xl sticky top-20">
                                ...
                                <div className="space-y-4 px-4 pb-3 pt-4">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">Siêu ứng dụng số 1 Việt Nam</p>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="flex items-center space-x-2">
                                    ...
                                    <Button className="w-full bg-pink-500 text-gray-100 text-base hover:bg-pink-600">Quyên góp</Button>
                                </div>
                            </div>
                        </div>
                    </div>
